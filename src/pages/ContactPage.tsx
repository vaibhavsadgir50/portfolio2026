const EMAIL = 'changirvaibhav@outlook.com';
const GITHUB_URL = 'https://github.com/vaibhavsadgir50';
const LINKEDIN_URL = 'https://www.linkedin.com/in/vaibhavchandgir/';
        ...
        <div className="glass-card glass-card--no-holo contact-section__card">
          <div className="glass-card__text">
            ...
            <div className="contact-section__links">
              <a href={`mailto:${EMAIL}`} className="hero-btn" aria-label="Email">
                <span className="hero-btn__inner">
                  {EMAIL_ICON}
                  <span className="hero-btn__label">Email</span>
                </span>
              </a>
              <a href={GITHUB_URL} className="hero-btn" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                <span className="hero-btn__inner">
                  {GITHUB_ICON}
                  <span className="hero-btn__label">GitHub</span>
                </span>
              </a>
              <a href={LINKEDIN_URL} className="hero-btn" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <span className="hero-btn__inner">
                  {LINKEDIN_ICON}
