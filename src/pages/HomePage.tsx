        ...
        <div className="glass-card glass-card--no-holo">
          <div className="glass-card__text">
            ...
            <div className="home-hero__buttons">
              ...
              <a href="https://github.com/vaibhavsadgir50" className="home-hero__social-link home-hero__social-link--github" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                <span className="home-hero__social-icon">{GITHUB_ICON}</span>
                <span className="home-hero__social-label">GitHub</span>
              </a>
              <a href="https://www.linkedin.com/in/vaibhavchandgir/" className="home-hero__social-link home-hero__social-link--linkedin" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <span className="home-hero__social-icon">{LINKEDIN_ICON}</span>
                <span className="home-hero__social-label">LinkedIn</span>
              </a>
            </div>
          </div>
          <img
